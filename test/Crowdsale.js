...
contract('LifToken Crowdsale', function(accounts) {
  ...
  it("Should simulate a crowdsale of 7m tokens with on ducth auction stage, using future discount and distribute 3M of the tokens using futurePayments", function(done) {
